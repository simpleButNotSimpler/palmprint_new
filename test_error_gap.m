...
raw_db_im = read_image(raw_db_name);
...
% dc_cropped_output_im = imresize(dc_cropped_output_im, [128, 128]);
% dc_cropped_db_im = imresize(dc_cropped_db_im, [128, 128]);
% 
% [temp, ~] = edgeresponse(dc_cropped_output_im);
% [~, dc_cropped_output_im] = edgeresponse(imcomplement(temp));
% 
...
% score = palmcode_diff_whole(dc_cropped_output_im, dc_cropped_db_im);
end